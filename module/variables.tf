...
variable "eks_scale_config_desired_size" {
  type        = number
  description = "(optional) describe your variable"
  default     = 2
}
variable "eks_scale_config_max_size" {
  type        = number
  description = "(optional) describe your variable"
  default     = 4
}
variable "eks_scale_config_min_size" {
  type        = number
  description = "(optional) describe your variable"
  default     = 4
}
...
variable "rds_allowed_cidrs" {
  description = "IP ranges from which MySQl traffic to be allowed"
  type        = list(string)
  default     = []
